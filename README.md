...
- [LuaSkills 0.5.5 package configuration guide](docs/upgrade-0.5.5.md): strict declarations, versioned stores, transactions, events, and SDK integration.
...
| --- | --- |
| LuaSkills core and FFI SDK | `0.5.7` |
